    ...
    >
      <div className="container mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-10">
          <a href="#projects" className="text-xs uppercase tracking-widest font-bold text-slate-500 dark:text-slate-400 hover:text-brand-purple dark:hover:text-white transition-colors">Portfólio</a>
